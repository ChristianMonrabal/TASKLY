            ...
            @if ($trabajo->imagenes && $trabajo->imagenes->count() > 0)
                <div class="galeria-imagenes">
                    ...
                    <div class="imagen-principal">
                        <img src="{{ asset('img/trabajos/' . $trabajo->imagenes->first()->ruta_imagen) }}"
                            alt="{{ $trabajo->titulo }}" id="imagen-grande">
                    </div>
                    ...
                    @if ($trabajo->imagenes->count() > 1)
                        <div class="galeria-miniaturas">
                            @foreach ($trabajo->imagenes as $imagen)
                                <div class="miniatura"
                                    onclick="cambiarImagen('{{ asset('img/trabajos/' . $imagen->ruta_imagen) }}')">
                            ...
                            <div class="botones-accion">
                                @if (Auth::check())
                                    @if (Auth::id() != $trabajo->cliente_id)
                                        <div class="boton-wrapper">
                                            ...
                                            @else
                                                <form class="postular-form"
                                                    action="{{ route('trabajos.postular', $trabajo->id) }}" method="POST">
                                                    @csrf
                                        ...
                                        <div class="boton-wrapper">
                                            <a href="{{ route('vista.chat', $trabajo->id) }}" class="btn btn-chat"
                                                title="Chatear">
